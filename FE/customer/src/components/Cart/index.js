            ...
            <div className="flex shadow-md my-10">
                <div className="w-3/4 bg-white px-10 py-10">
                    ...
                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                        <div className="flex w-2/5">
                            <div className="w-20">
                                <img className="h-24" src='https://firebasestorage.googleapis.com/v0/b/sport-courts-ab2d8.appspot.com/o/courts%2FS%C3%A2n%20C%E1%BB%8F%20Nh%C3%A2n%20T%E1%BA%A1o%20Ho%C3%A0ng%20Kim?alt=media&token=0ee70100-e56a-4ac8-944e-56b3d2927d66' alt='abc' />
                            </div>
                            <div className="flex flex-col justify-between ml-4 flex-grow">
                                <span className="font-bold text-sm">ABC</span>
                                <span className="text-red-500 text-xs capitalize">ABC</span>
                                <div className="font-semibold hover:text-red-500 text-gray-500 text-xs cursor-pointer">Remove</div>
                            </div>
                        </div>
                        <div className="flex justify-center w-1/5">
                            <svg className="fill-current text-gray-600 w-3 cursor-pointer" viewBox="0 0 448 512"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" /></svg>
                        ...
                        <span className="text-center w-1/5 font-semibold text-sm">$655</span>
                        <span className="text-center w-1/5 font-semibold text-sm">$700</span>
                    </div>
                ...
                <div id="summary" className="w-1/4 px-8 py-10">
                    ...
                    <div className="flex justify-between mt-10 mb-5">
                        ...
                        <span className="font-semibold text-sm">2141$</span>
                    </div>
                    <div>
